local __LOLWHAT_BUNDLE_MODULES = { cache = {} }
do
	do
		...
		function __LOLWHAT_BUNDLE_MODULES.a()
			local v = __LOLWHAT_BUNDLE_MODULES.cache.a
			if not v then
				v = { c = __modImpl() }
				__LOLWHAT_BUNDLE_MODULES.cache.a = v
			end
			return v.c
		end
	end
	do
		...
		function __LOLWHAT_BUNDLE_MODULES.b()
			local v = __LOLWHAT_BUNDLE_MODULES.cache.b
			if not v then
				v = { c = __modImpl() }
				__LOLWHAT_BUNDLE_MODULES.cache.b = v
			end
			return v.c
		end
	end
	do
		...
		function __LOLWHAT_BUNDLE_MODULES.c()
			local v = __LOLWHAT_BUNDLE_MODULES.cache.c
			if not v then
				v = { c = __modImpl() }
				__LOLWHAT_BUNDLE_MODULES.cache.c = v
			end
			return v.c
		end
	end
	do
		local function __modImpl()
			local logger = {}
			local config = __LOLWHAT_BUNDLE_MODULES.a()
			local colors = __LOLWHAT_BUNDLE_MODULES.c()
			logger.LogLevel = {
				Error = 0,
				Warn = 1,
				Log = 2,
		...
		function __LOLWHAT_BUNDLE_MODULES.d()
			local v = __LOLWHAT_BUNDLE_MODULES.cache.d
			if not v then
				v = { c = __modImpl() }
				__LOLWHAT_BUNDLE_MODULES.cache.d = v
			end
			return v.c
		end
	end
	do
		...
		function __LOLWHAT_BUNDLE_MODULES.e()
			local v = __LOLWHAT_BUNDLE_MODULES.cache.e
			if not v then
				v = { c = __modImpl() }
				__LOLWHAT_BUNDLE_MODULES.cache.e = v
			end
			return v.c
		end
	end
	do
		local function __modImpl()
			...
			local logger = __LOLWHAT_BUNDLE_MODULES.d()
			local bit32 = __LOLWHAT_BUNDLE_MODULES.e().bit32
		...
		function __LOLWHAT_BUNDLE_MODULES.f()
			local v = __LOLWHAT_BUNDLE_MODULES.cache.f
			if not v then
				v = { c = __modImpl() }
				__LOLWHAT_BUNDLE_MODULES.cache.f = v
			end
			return v.c
		end
	end
	do
		local function __modImpl()
			local Enums = {}
			local chararray = __LOLWHAT_BUNDLE_MODULES.f().chararray
			Enums.LuaVersion = {
				LuaU = "LuaU",
				Lua51 = "Lua51",
			}
		...
		function __LOLWHAT_BUNDLE_MODULES.g()
			local v = __LOLWHAT_BUNDLE_MODULES.cache.g
			if not v then
				v = { c = __modImpl() }
				__LOLWHAT_BUNDLE_MODULES.cache.g = v
			end
			return v.c
		end
	end
	do
		local function __modImpl()
			local Enums = __LOLWHAT_BUNDLE_MODULES.g()
			local util = __LOLWHAT_BUNDLE_MODULES.f()
			local logger = __LOLWHAT_BUNDLE_MODULES.d()
			local config = __LOLWHAT_BUNDLE_MODULES.a()
		...
		function __LOLWHAT_BUNDLE_MODULES.h()
			local v = __LOLWHAT_BUNDLE_MODULES.cache.h
			if not v then
				v = { c = __modImpl() }
				__LOLWHAT_BUNDLE_MODULES.cache.h = v
			end
			return v.c
		end
	end
	do
		...
		function __LOLWHAT_BUNDLE_MODULES.i()
			local v = __LOLWHAT_BUNDLE_MODULES.cache.i
			if not v then
				v = { c = __modImpl() }
				__LOLWHAT_BUNDLE_MODULES.cache.i = v
			end
			return v.c
		end
	end
	do
		local function __modImpl()
			local Tokenizer = __LOLWHAT_BUNDLE_MODULES.h()
			local Enums = __LOLWHAT_BUNDLE_MODULES.g()
			local util = __LOLWHAT_BUNDLE_MODULES.f()
			local Ast = __LOLWHAT_BUNDLE_MODULES.b()
			local Scope = __LOLWHAT_BUNDLE_MODULES.i()
			local logger = __LOLWHAT_BUNDLE_MODULES.d()
		...
		function __LOLWHAT_BUNDLE_MODULES.j()
			local v = __LOLWHAT_BUNDLE_MODULES.cache.j
			if not v then
				v = { c = __modImpl() }
				__LOLWHAT_BUNDLE_MODULES.cache.j = v
			end
			return v.c
		end
	end
	do
		...
		function __LOLWHAT_BUNDLE_MODULES.k()
			local v = __LOLWHAT_BUNDLE_MODULES.cache.k
			if not v then
				v = { c = __modImpl() }
				__LOLWHAT_BUNDLE_MODULES.cache.k = v
			end
			return v.c
		end
	end
	do
		...
		function __LOLWHAT_BUNDLE_MODULES.l()
			local v = __LOLWHAT_BUNDLE_MODULES.cache.l
			if not v then
				v = { c = __modImpl() }
				__LOLWHAT_BUNDLE_MODULES.cache.l = v
			end
			return v.c
		end
	end
	do
		local function __modImpl()
			return {
				Chaotic = __LOLWHAT_BUNDLE_MODULES.l(),
			}
		end
		function __LOLWHAT_BUNDLE_MODULES.m()
			local v = __LOLWHAT_BUNDLE_MODULES.cache.m
			if not v then
				v = { c = __modImpl() }
				__LOLWHAT_BUNDLE_MODULES.cache.m = v
			end
			return v.c
		end
	end
	do
		...
		function __LOLWHAT_BUNDLE_MODULES.n()
			local v = __LOLWHAT_BUNDLE_MODULES.cache.n
			if not v then
				v = { c = __modImpl() }
				__LOLWHAT_BUNDLE_MODULES.cache.n = v
			end
			return v.c
		end
	end
	do
		local function __modImpl()
			local Step = __LOLWHAT_BUNDLE_MODULES.n()
			local Ast = __LOLWHAT_BUNDLE_MODULES.b()
			local Scope = __LOLWHAT_BUNDLE_MODULES.i()
			local AstKind = Ast.AstKind
		...
		function __LOLWHAT_BUNDLE_MODULES.o()
			local v = __LOLWHAT_BUNDLE_MODULES.cache.o
			if not v then
				v = { c = __modImpl() }
				__LOLWHAT_BUNDLE_MODULES.cache.o = v
			end
			return v.c
		end
	end
	do
		local function __modImpl()
			local Ast = __LOLWHAT_BUNDLE_MODULES.b()
			local utils = __LOLWHAT_BUNDLE_MODULES.f()
		...
		function __LOLWHAT_BUNDLE_MODULES.p()
			local v = __LOLWHAT_BUNDLE_MODULES.cache.p
			if not v then
				v = { c = __modImpl() }
				__LOLWHAT_BUNDLE_MODULES.cache.p = v
			end
			return v.c
		end
	end
	do
		...
		function __LOLWHAT_BUNDLE_MODULES.q()
			local v = __LOLWHAT_BUNDLE_MODULES.cache.q
			if not v then
				v = { c = __modImpl() }
				__LOLWHAT_BUNDLE_MODULES.cache.q = v
			end
			return v.c
		end
	end
	do
		local function __modImpl()
			...
			local Ast = __LOLWHAT_BUNDLE_MODULES.b()
			local Scope = __LOLWHAT_BUNDLE_MODULES.i()
			local RandomStrings = __LOLWHAT_BUNDLE_MODULES.p()
			local Parser = __LOLWHAT_BUNDLE_MODULES.j()
			local Enums = __LOLWHAT_BUNDLE_MODULES.g()
			local logger = __LOLWHAT_BUNDLE_MODULES.d()
			local visitast = __LOLWHAT_BUNDLE_MODULES.q()
			local util = __LOLWHAT_BUNDLE_MODULES.f()
			local AstKind = Ast.AstKind
		...
		function __LOLWHAT_BUNDLE_MODULES.r()
			local v = __LOLWHAT_BUNDLE_MODULES.cache.r
			if not v then
				v = { c = __modImpl() }
				__LOLWHAT_BUNDLE_MODULES.cache.r = v
			end
			return v.c
		end
	end
	do
		...
		function __LOLWHAT_BUNDLE_MODULES.s()
			local v = __LOLWHAT_BUNDLE_MODULES.cache.s
			if not v then
				v = { c = __modImpl() }
				__LOLWHAT_BUNDLE_MODULES.cache.s = v
			end
			return v.c
		end
	end
	do
		...
		function __LOLWHAT_BUNDLE_MODULES.t()
			local v = __LOLWHAT_BUNDLE_MODULES.cache.t
			if not v then
				v = { c = __modImpl() }
				__LOLWHAT_BUNDLE_MODULES.cache.t = v
			end
			return v.c
		end
	end
	do
		...
		function __LOLWHAT_BUNDLE_MODULES.u()
			local v = __LOLWHAT_BUNDLE_MODULES.cache.u
			if not v then
				v = { c = __modImpl() }
				__LOLWHAT_BUNDLE_MODULES.cache.u = v
			end
			return v.c
		end
	end
	do
		...
		function __LOLWHAT_BUNDLE_MODULES.v()
			local v = __LOLWHAT_BUNDLE_MODULES.cache.v
			if not v then
				v = { c = __modImpl() }
				__LOLWHAT_BUNDLE_MODULES.cache.v = v
			end
			return v.c
		end
	end
	do
		...
		function __LOLWHAT_BUNDLE_MODULES.w()
			local v = __LOLWHAT_BUNDLE_MODULES.cache.w
			if not v then
				v = { c = __modImpl() }
				__LOLWHAT_BUNDLE_MODULES.cache.w = v
			end
			return v.c
		end
	end
	do
		...
		function __LOLWHAT_BUNDLE_MODULES.x()
			local v = __LOLWHAT_BUNDLE_MODULES.cache.x
			if not v then
				v = { c = __modImpl() }
				__LOLWHAT_BUNDLE_MODULES.cache.x = v
			end
			return v.c
		end
	end
	do
		...
		function __LOLWHAT_BUNDLE_MODULES.y()
			local v = __LOLWHAT_BUNDLE_MODULES.cache.y
			if not v then
				v = { c = __modImpl() }
				__LOLWHAT_BUNDLE_MODULES.cache.y = v
			end
			return v.c
		end
	end
	do
		...
		function __LOLWHAT_BUNDLE_MODULES.z()
			local v = __LOLWHAT_BUNDLE_MODULES.cache.z
			if not v then
				v = { c = __modImpl() }
				__LOLWHAT_BUNDLE_MODULES.cache.z = v
			end
			return v.c
		end
	end
	...
	do
		local function __modImpl()
			local Step = __LOLWHAT_BUNDLE_MODULES.n()
			local Compiler = __LOLWHAT_BUNDLE_MODULES.A()
			local Optimizer = __LOLWHAT_BUNDLE_MODULES.B()
	...
	do
		local function __modImpl()
			return {
				InvertedExecution = __LOLWHAT_BUNDLE_MODULES.o(),
				EncryptStrings = __LOLWHAT_BUNDLE_MODULES.r(),
				SplitStrings = __LOLWHAT_BUNDLE_MODULES.s(),
				AntiTamper = __LOLWHAT_BUNDLE_MODULES.t(),
				DynamicXOR = __LOLWHAT_BUNDLE_MODULES.u(),
				DynamicDecrypt = __LOLWHAT_BUNDLE_MODULES.v(),
				DynamicJumps = __LOLWHAT_BUNDLE_MODULES.w(),
				ConstantsObfuscator = __LOLWHAT_BUNDLE_MODULES.x(),
				NumbersToExpressions = __LOLWHAT_BUNDLE_MODULES.y(),
				OpaquePredicates = __LOLWHAT_BUNDLE_MODULES.z(),
				Vmify = __LOLWHAT_BUNDLE_MODULES.C(),
				StatementFlattener = __LOLWHAT_BUNDLE_MODULES.D(),
				AntiDump = __LOLWHAT_BUNDLE_MODULES.E(),
				VirtualGlobals = __LOLWHAT_BUNDLE_MODULES.F(),
				FakeLoopWrap = __LOLWHAT_BUNDLE_MODULES.G(),
				WrapInFunction = __LOLWHAT_BUNDLE_MODULES.H(),
				Compressor = __LOLWHAT_BUNDLE_MODULES.I(),
				DeadCodeEliminator = __LOLWHAT_BUNDLE_MODULES.J(),
				BootstrapObfuscator = __LOLWHAT_BUNDLE_MODULES.P(),
			}
		end
		function __LOLWHAT_BUNDLE_MODULES.K()
			local v = __LOLWHAT_BUNDLE_MODULES.cache.K
	...
	do
		local function __modImpl()
			...
			local util = __LOLWHAT_BUNDLE_MODULES.f()
			local Parser = __LOLWHAT_BUNDLE_MODULES.j()
			local Unparser = __LOLWHAT_BUNDLE_MODULES.k()
			local logger = __LOLWHAT_BUNDLE_MODULES.d()
			local NameGenerators = __LOLWHAT_BUNDLE_MODULES.m()
			local Steps = __LOLWHAT_BUNDLE_MODULES.K()
			local lookupify = util.lookupify
			local LuaVersion = Enums.LuaVersion
			local AstKind = Ast.AstKind
	...
	do
		local function __modImpl()
			...
			local colors = __LOLWHAT_BUNDLE_MODULES.c()
			local TokenKind = Tokenizer.TokenKind
			local lookupify = __LOLWHAT_BUNDLE_MODULES.f().lookupify
			...
			return {
				["Luraph"] = {
  			    ...
  			    --{ Name = "AntiTamper", Settings = { UseDebug = false } },
						...
						{ Name = "DynamicXOR", Settings = { Treshold = 0.70 } },
					   ...
					   -- { Name = "BootstrapObfuscator", Settings = { StatementsPerState = 1, AddJunkState = false } }, --Broken atm
	...
	do
		local function __modImpl()
			...
			local Pipeline = __LOLWHAT_BUNDLE_MODULES.L()
			local highlight = __LOLWHAT_BUNDLE_MODULES.M()
			local colors = __LOLWHAT_BUNDLE_MODULES.c()
			local Logger = __LOLWHAT_BUNDLE_MODULES.d()
			local Presets = __LOLWHAT_BUNDLE_MODULES.N()
			local Config = __LOLWHAT_BUNDLE_MODULES.a()
			local util = __LOLWHAT_BUNDLE_MODULES.f()
			return {
				Pipeline = Pipeline,
...
local ZukaTech = __LOLWHAT_BUNDLE_MODULES.O()
local LUAU_SIGNALS = {
	"compound assignment",
	"continue",
	"type annotation",
...
if arg and arg[0] then
	...
	if not inputFile then
		io.stderr:write("Usage: lua main.lua <input.lua> [output.lua]\n")
		os.exit(1)
	end
	...
	local preset = {}
	for k, v in pairs(ZukaTech.Presets["Luraph"]) do
		preset[k] = v
	end
